...
const PasswordModal = ({
  ...
  const handleChangePassword = () => {
    ...
    onConfirm(textValue); // Renvoie au parent
  ...
  return (
    <div>
      <div className="fixed inset-0 bg-gray-500/25 transition-opacity data-closed:opacity-0 data-enter:duration-300 data-enter:ease-out data-leave:duration-200 data-leave:ease-in">
        {" "}
      </div>
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
        <div className="relative w-full max-w-md p-6 bg-white rounded-lg shadow-lg dark:bg-gray-800">
          <div className="flex flex-col items-center justify-center gap-2">
            <Logo />
            <h2 className="flex text-xl font-semibold mb-4 text-black dark:text-white justify-self-center">
              {label}
            </h2>
          </div>
          <button
          ...
          <input
            className="mt-3 mb-3 w-full border-gray-400 border rounded text-black overflow-auto p-3"
