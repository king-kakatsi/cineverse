...
export default function LoginPage() {
  ...
  return (
    <div className="bg-white dark:bg-gray-800 flex justify-center items-center w-screen h-screen p-5 py-85">
            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
              {oauthLogin && (
                <div className="text-gray-500">
                  Login proccessing wait a minute...
                </div>
              )}
              ...
              <div>
                <button
                  type="submit"
                  className={`mt-8 w-full flex justify-center py-3 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-red-800 hover:bg-red-700 focus:outline-none focus:ring-2 cursor-pointer focus:ring-offset-2 focus:ring-red-500 ${
                    oauthLogin || login ? "disabled:bg-gray-500" : ""
                  }`}
                >
                  {login ? "Login...." : "Login"}
                </button>
            ...
            <div className="mt-6">
              ...
              <div className="mt-6 grid grid-cols-2 gap-3">
                <button
                  ...
                  type="button"
                  className="w-full inline-flex justify-center py-3 px-4 border border-gray-300 rounded-md shadow-sm bg-white cursor-pointer text-sm font-medium text-gray-700 hover:bg-gray-50"
                >
                  <img
                ...
                <button
                  ...
                  type="button"
                  className="w-full inline-flex justify-center py-3 px-4 border cursor-pointer border-gray-300 rounded-md shadow-sm bg-white text-sm font-medium text-gray-700 hover:bg-gray-50"
                >
                  <img
